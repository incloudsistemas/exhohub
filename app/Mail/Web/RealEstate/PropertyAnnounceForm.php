...
namespace App\Mail\Web\RealEstate;
...
class PropertyAnnounceForm extends Mailable
{
    ...
    public function build(): self
    {
        ...
        $subject = $this->data['subject'] ?? 'Novo Anúncio de Imóvel Registrado';
        ...
        return $this->subject("[$appName] $subject")
            ...
            ->markdown('web.emails.property-announce-form');
    }
}
