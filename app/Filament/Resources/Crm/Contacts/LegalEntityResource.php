            ...
            ->schema([
                ...
                Forms\Components\Select::make('individuals')
                    ...
                    ->getOptionLabelsUsing(
                        ...
                        $service->getIndividualOptionsLabel(values: $values),
                    )
                    ->when(
                        ...
                        $component->suffixAction(
                            ...
                            $service->getQuickCreateActionByContactIndividuals(field: 'individuals', multiple: true),
                        ),
                    )
                    ->columnSpanFull(),
            ...
            ->actions([
                Tables\Actions\ActionGroup::make([
                    ...
                    Tables\Actions\DeleteAction::make()
                        ->before(
                            fn(LegalEntityService $service, Tables\Actions\DeleteAction $action, LegalEntity $record) =>
                            $service->preventLegalEntityDeleteIf(action: $action, legalEntity: $record)
                        ),
                ]),
            ])
            ->bulkActions([
